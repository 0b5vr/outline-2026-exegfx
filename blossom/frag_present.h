...
const char *present_frag =
 ...
 "{"
   ...
   "vec3 f=m.xyz/m.w*mat3(.59719,.35458,.04823,.076,.90834,.01566,.0284,.13383,.83777);"
   "f=clamp((f*(f+.0245786f)-90537e-9f)/(f*(.983729f*f+.432951f)+.238081f)*mat3(1.60475,-.53108,-.07367,-.10208,1.10813,-.00605,-.00327,-.07276,1.07602),0.,1.);"
   "f=mix(vec3(.03),vec3(.9),mix(f*12.92,pow(f,vec3(.4167))*1.055-.055,step(.0031308,f)));"
   "v=vec4(f,1);"
 "}";
